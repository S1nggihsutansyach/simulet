...
<html lang="zxx">
    <head>
        ...
        <link
            rel="stylesheet"
            href="frontend/css/owl.carousel.min.css"
            type="text/css"
        />
    ...
    <body>
        ...
        <div class="humberger__menu__wrapper">
            <div class="humberger__menu__logo">
                <a href="{{ route('home.index') }}"><h6>UlaPetshop</h6></a>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="hero__search">
                            <div class="hero__search__form">
                                <form action="{{ route('cariproduk.index') }}">
                                    @csrf
                                    <input
                                        type="text"
        ...
        <section class="mb-5">
            <div class="container">
                <div class="hero__item set-bg" data-setbg="frontend/img/bannerula.jpg">
